    ...
    <div class="container">
        ...
        <div class="contact">
            <form  method="post">
                ...
                <input type="date" name="dateout" placeholder="Enter Date out" required>
                <input type="date" name="datein" placeholder="Enter Date In" required>
...
<?php
include 'config.php';
$sql = "INSERT INTO loan VALUES ('$username', '$catalogno', '$dataout','$datein')";
try{
    $conn->exec($sql);
