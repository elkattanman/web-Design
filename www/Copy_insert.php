...
$catalogno= $isbn = $location = $max = $charge= "";
    ...
    <div class="container">
        ...
        <div class="contact">
            <form  method="post">
                ...
                <input type="text" name="location" placeholder="Enter Book Location" required>
                <input type="text" name="max" placeholder="Enter Max Day For loan" required>
                <input type="text" name="charge" placeholder="Enter Charge Dely For Day" required>
                <br>
...
<?php
include 'config.php';
$sql = "INSERT INTO physical_copy VALUES ('$catalogno', '$isbn', '$location','$max','$charge')";
try{
    $conn->exec($sql);
